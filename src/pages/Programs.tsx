      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filtered.map((program) => (
            ...
            >
              <PlaceholderImage label={program.title} className="h-44 rounded-none border-0 rounded-t-xl" />
              <div className="p-6">
                ...
                <p className="text-sm text-[#8b949e] leading-relaxed mb-3">{program.shortDesc}</p>
